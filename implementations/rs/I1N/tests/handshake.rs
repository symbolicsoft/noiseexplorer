...
use noiseexplorer_i1n::{noisesession::NoiseSession,
														...
														.recv_message(messageA.clone(),)
													{
														if let Ok(mB,) = Message::from_str(
															...
															if let Ok(tB,) = Message::from_str(
																"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088438ff3798b0999765a7dccf74d01b15bc254c63495b65a9ab5c58c0f80e7ee43",
															) {
																if let Ok(messageB,) =
																	responder_session
																		.send_message(mB,)
																{
																	if let Ok(_x,) =
																		...
																		if let Ok(mC,) =
																			...
																			if let Ok(tC,) =
																				Message::from_str(
																					"959e317e30d0f736ea17dbdb4b25ba0aa95e61bccf928fcc15e873",
																				) {
