...
fn test() {
	...
	let initStaticA: I1X::Keypair = I1X::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: I1X::Keypair = I1X::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: I1X::Keypair = I1X::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let mut initiatorSession: I1X::NoiseSession =
	I1X::NoiseSession::InitSession(true, &prologue, initStaticA, I1X::EMPTY_KEY);
	let mut responderSession: I1X::NoiseSession =
	I1X::NoiseSession::InitSession(false, &prologue, respStatic, I1X::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(I1X::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(I1X::Keypair::new_k(decode_str_32(
