...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088432830411f43b780306e3f94b9e3becb18016c41fd51fa7ed38f1a6217bdee11") {
	...
	if let Ok(tC) = Message::from_str("822184f6ad708b7539c99ed858caf5ba56f2c57ba55d34dd3b6778") {
	...
	if let Ok(tD) = Message::from_str("2f97e72757dd3b46921ce96827cca0d01e819cfc7db9aaa85019b5") {
	...
	if let Ok(tE) = Message::from_str("bea8ecf42785759819282424c5547c1f98b871a67d1d6e3fdcfb6c2c65d54f2ea1") {
	...
	if let Ok(tF) = Message::from_str("3c9d968a1c6036ef29ef6a031678c621d1629cb96e25d8f11dfaa29e1591c5648e22089217") {
