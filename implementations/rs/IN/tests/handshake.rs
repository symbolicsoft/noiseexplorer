...
fn test() {
	...
	let initStaticA: IN::Keypair = IN::Keypair::new_k(IN::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: IN::Keypair = IN::Keypair::new_k(IN::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
