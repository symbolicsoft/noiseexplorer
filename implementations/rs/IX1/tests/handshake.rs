...
let mut initiator_session: NoiseSession = NoiseSession::init_session(true, prologue.clone(), init_static_kp);
	let mut responder_session: NoiseSession = NoiseSession::init_session(false, prologue, resp_static_kp);
...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tA) = Message::from_bytes(&decode_str("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79446bc3822a2aa7f4e6981d6538692b3cdf3e6df9eea6ed269eb41d93c22757b75a4c756477696720766f6e204d69736573")[..]) {
	...
	if let Ok(tB) = Message::from_bytes(&decode_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088430363f728c82edd54d4f71350d2c4f7f5af1bed4b49ef675e794191fbe71850f61cecca65b10d1d23042946d173110d1829d651eb05dd70c2669887e79a3a63ab7d965042b982c015e735e4daa3a3e6")[..]) {
	...
	if let Ok(tC) = Message::from_bytes(&decode_str("cab545be46f12f865c4dfa1bedfad43b3fd74bbba68b782e00a604")[..]) {
	...
	if let Ok(tD) = Message::from_bytes(&decode_str("8faa9cae6553c0ba4f954103cd73b85dd1c656d180a15225147bbd")[..]) {
	...
	if let Ok(tE) = Message::from_bytes(&decode_str("b0ac0e3dfef53d59c6ac663edc510022e5a2bc02472b5b572f90a8384838037c1d")[..]) {
	...
	if let Ok(tF) = Message::from_bytes(&decode_str("90d7cd3c583f94f09f776abb4fa99b430e4f442c710194314a42949d0a167df36a7714ad1b")[..]) {
