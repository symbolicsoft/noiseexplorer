...
use noiseexplorer_k::{noisesession::NoiseSession,
										...
										Keypair::from_private_key(initiator_ephemeral_private,)
									{
											...
											Message::from_str("4c756477696720766f6e204d69736573",)
										{
											if let Ok(tA,) = Message::from_str(
												"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79443ab57eb07c96791ebddff95c2ed2ccfe412d87270c753c0a5b5fe46164087647",
											) {
												if let Ok(messageA,) =
														...
														.recv_message(messageA.clone(),)
													{
														if let Ok(mB,) = Message::from_str(
															...
															if let Ok(tB,) = Message::from_str(
																"3e7b4d83fa0cca62cc0b6d202da416c0b59289e518982742851e534f1916f8",
															) {
																if let Ok(messageB,) =
																	responder_session
																		.send_message(mB,)
																{
																	if let Ok(_x,) =
																		...
																		if let Ok(mC,) =
																			...
																			if let Ok(tC,) =
																				Message::from_str(
																					"d52fe3eee4de396b592afea7eb632020587aa4384200ed9bca9585",
																				) {
