...
fn test() {
	...
	let initStatic: K::Keypair = K::Keypair::new_k(K::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	K::NoiseSession::InitSession(true, &prologue, initStatic, respStatic.pk.0);
	let mut responderSession: K::NoiseSession =
	K::NoiseSession::InitSession(false, &prologue, respStatic, initStatic.pk.0);
