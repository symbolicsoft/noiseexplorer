...
fn test() {
	...
	let initStaticA: K1X1::Keypair = K1X1::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: K1X1::Keypair = K1X1::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let initStaticB: K1X1::Keypair = K1X1::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let mut initiatorSession: K1X1::NoiseSession =
	K1X1::NoiseSession::InitSession(true, &prologue, initStaticA, K1X1::EMPTY_KEY);
	let mut responderSession: K1X1::NoiseSession =
	K1X1::NoiseSession::InitSession(false, &prologue, respStatic, initStaticB.pk.0);
	initiatorSession.set_ephemeral_keypair(K1X1::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(K1X1::Keypair::new_k(decode_str_32(
		"bbdb4cdbd309f1a1f2e1456967fe288cadd6f712d65dc7b7793d5e63da6b375b"
	)));
	let payloadA = decode_str("4c756477696720766f6e204d69736573");
	let mut messageA: K1X1::MessageBuffer = initiatorSession.SendMessage(&payloadA);
	...
	let mut messageB: K1X1::MessageBuffer = responderSession.SendMessage(&payloadB);
	...
	let mut messageC: K1X1::MessageBuffer = initiatorSession.SendMessage(&payloadC);
	...
	let mut messageD: K1X1::MessageBuffer = responderSession.SendMessage(&payloadD);
	...
	let mut messageE: K1X1::MessageBuffer = initiatorSession.SendMessage(&payloadE);
	...
	let mut messageF: K1X1::MessageBuffer = responderSession.SendMessage(&payloadF);
