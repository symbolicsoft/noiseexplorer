...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f14480884337f40e528241fa003e524cfb460cab5a9555687b1c4aba1637693509ce52b562f0876aad09b4f499d381c3922d11c3173a44bf355f1feac074e4bfe73f81f9450dbdf8a678db5e3d9bb88f0e159b05") {
	...
	if let Ok(tC) = Message::from_str("af0a97e1d84889a64602b14c98c4de7b594f762e8aad6086153d6d") {
	...
	if let Ok(tD) = Message::from_str("9022bf4f4ccb8e27a813bea4eb1b974062d12cb2644ab01bf72cc2") {
	...
	if let Ok(tE) = Message::from_str("639911393d75ca7f6bd3e4482d445fbfbe1c54291e4ea685a10f96399f777e3955") {
	...
	if let Ok(tF) = Message::from_str("997dc653d921d2f79df41807a15af7f257224bd5817bae1cf102a337cacef73908cf3fb12b") {
