...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088439007d1439c3dc50d0f9ded2680d0995f10ec0e960871aa8a01b8165e6e297f") {
	...
	if let Ok(tC) = Message::from_str("b79d477f052726df83371225d9f14290b85be44811e6a5479ac49c") {
	...
	if let Ok(tD) = Message::from_str("c31f5db821af2a7b24fe039810b8d4f07653e16b33c8b954c8d86c") {
	...
	if let Ok(tE) = Message::from_str("004c129957669013562bc14cb11c868ecd4fab4dbaac1794916b0e7a49ee27e19d") {
	...
	if let Ok(tF) = Message::from_str("1a50c6939a635df3d49d310f8f5dd1a98ca799aabcb7210e2c0c610580978e6caadaf7c913") {
