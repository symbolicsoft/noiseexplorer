...
fn test() {
	...
	let initStaticA: KN::Keypair = KN::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: KN::Keypair = KN::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: KN::Keypair = KN::Keypair::new_k(KN::EMPTY_KEY);
	let mut initiatorSession: KN::NoiseSession =
	KN::NoiseSession::InitSession(true, &prologue, initStaticA, KN::EMPTY_KEY);
	let mut responderSession: KN::NoiseSession =
	KN::NoiseSession::InitSession(false, &prologue, respStatic, initStaticB.pk.0);
	initiatorSession.set_ephemeral_keypair(KN::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(KN::Keypair::new_k(decode_str_32(
