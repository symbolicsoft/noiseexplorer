...
use noiseexplorer_knpsk2::{noisesession::NoiseSession,
											...
											if let Ok(responder_ephemeral_kp,) =
												...
												if let Ok(mA,) = Message::from_str(
													...
													if let Ok(tA,) = Message::from_str(
														"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c7944d8b18198501b129b05163c3b4ea9e59ef49238f28730d4398699fba2e78391c0",
													) {
														if let Ok(messageA,) =
															initiator_session.send_message(mA,)
														{
																...
																.recv_message(messageA.clone(),)
															{
																if let Ok(mB,) = Message::from_str(
																	...
																	if let Ok(tB,) =
																		Message::from_str(
																			"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f14480884374519fa9659111620fe0c21e8b62e878e1819f85da30424693628ca755fc24",
																		) {
																		if let Ok(messageB,) =
																			responder_session
																				.send_message(mB,)
