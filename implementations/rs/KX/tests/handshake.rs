...
fn test() {
	...
	let initStaticA: KX::Keypair = KX::Keypair::new_k(KX::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: KX::Keypair = KX::Keypair::new_k(KX::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
