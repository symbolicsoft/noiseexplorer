...
fn test() {
	...
	let initStaticA: KX1::Keypair = KX1::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: KX1::Keypair = KX1::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let initStaticB: KX1::Keypair = KX1::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let mut initiatorSession: KX1::NoiseSession =
	KX1::NoiseSession::InitSession(true, &prologue, initStaticA, KX1::EMPTY_KEY);
	let mut responderSession: KX1::NoiseSession =
	KX1::NoiseSession::InitSession(false, &prologue, respStatic, initStaticB.pk.0);
	initiatorSession.set_ephemeral_keypair(KX1::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(KX1::Keypair::new_k(decode_str_32(
