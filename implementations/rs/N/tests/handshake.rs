...
fn noiseexplorer_test_n() {
                        ...
                        if let Ok(resp_static_kp) = Keypair::from_private_key(resp_static_private) {
                            ...
                            if let Ok(initiator_ephemeral_private) = PrivateKey::from_str(
                                    ...
                                    Keypair::from_private_key(initiator_ephemeral_private)
                                {
                                    ...
                                    {
                                        if let Ok(tA) = Message::from_str("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79441b168ed8bbe8220b52bbbde6593d109d78c299b567f6e69276efcf2659c39073") {
	...
	if let Ok(tB) = Message::from_str("a7b5d1962001e9c4d965ea5f133941e9e6989094bcde637a582c34b954f34a") {
	...
	if let Ok(tC) = Message::from_str("16ff2557d5d671abe58c88d2a31b58e3a494ab3a6498124be0ea3f") {
