...
fn test() {
	...
	let initStaticA: N::Keypair = N::Keypair::new_k(N::EMPTY_KEY);
	let initStaticB: N::Keypair = N::Keypair::new_k(N::EMPTY_KEY);
	let respStatic: N::Keypair = N::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let mut initiatorSession: N::NoiseSession =
	N::NoiseSession::InitSession(true, &prologue, initStaticA, respStatic.pk.0);
	let mut responderSession: N::NoiseSession =
	N::NoiseSession::InitSession(false, &prologue, respStatic, N::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(N::Keypair::new_k(decode_str_32(
