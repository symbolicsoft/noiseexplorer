...
fn test() {
	...
	let initStaticA: NK::Keypair = NK::Keypair::new_k(NK::EMPTY_KEY);
	let initStaticB: NK::Keypair = NK::Keypair::new_k(NK::EMPTY_KEY);
	let respStatic: NK::Keypair = NK::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let mut initiatorSession: NK::NoiseSession =
	NK::NoiseSession::InitSession(true, &prologue, initStaticA, respStatic.pk.0);
	let mut responderSession: NK::NoiseSession =
	NK::NoiseSession::InitSession(false, &prologue, respStatic, NK::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(NK::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(NK::Keypair::new_k(decode_str_32(
