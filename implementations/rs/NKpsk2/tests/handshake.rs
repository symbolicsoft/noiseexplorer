...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tA) = Message::from_str("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79449b81e7722cc191126a9d3892203ec4cd791774188424a23f684ff03c726273de") {
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f144808843d06453b74535a533d3ccb782a50b4f48c80f82d3b6d1bf72692144691a634f") {
	...
	if let Ok(tC) = Message::from_str("a6f7f4f5af57e015ee7e1a4113e09f637b9ed27d24cda23ab29262") {
	...
	if let Ok(tD) = Message::from_str("847a9067b69a7c5455900d88f5ce079487866a505ad8844929ebcc") {
	...
	if let Ok(tE) = Message::from_str("200d2686b66fe57c3ca8f24c37c04c64e6cba6fe08bbd5301d6d4734c1caf5b634") {
	...
	if let Ok(tF) = Message::from_str("b78d4f43dbbc99b97a64865b55e1856f4c97e95638666437c805a3f331ad4b48c5c31e7623") {
