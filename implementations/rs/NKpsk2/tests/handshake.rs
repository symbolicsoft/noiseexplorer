...
use noiseexplorer_nkpsk2::{noisesession::NoiseSession,
											...
											if let Ok(responder_ephemeral_kp,) =
												...
												if let Ok(mA,) = Message::from_str(
													...
													if let Ok(tA,) = Message::from_str(
														"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79449b81e7722cc191126a9d3892203ec4cd791774188424a23f684ff03c726273de",
													) {
														if let Ok(messageA,) =
															initiator_session.send_message(mA,)
														{
																...
																.recv_message(messageA.clone(),)
															{
																if let Ok(mB,) = Message::from_str(
																	...
																	if let Ok(tB,) =
																		Message::from_str(
																			"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f144808843d06453b74535a533d3ccb782a50b4f48c80f82d3b6d1bf72692144691a634f",
																		) {
																		if let Ok(messageB,) =
																			responder_session
																				.send_message(mB,)
