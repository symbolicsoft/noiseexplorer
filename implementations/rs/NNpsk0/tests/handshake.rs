...
fn noiseexplorer_test_nnpsk0() {
                                        ...
                                        PrivateKey::from_str("4a6f686e2047616c74")
                                    {
                                            ...
                                            Keypair::from_private_key(responder_ephemeral_private)
                                        {
                                            ...
                                            if let Ok(mA) = Message::from_str(
                                                ...
                                                if let Ok(tA) = Message::from_str("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c7944fda936bec35a8adfdff198386f7d5475880897edaaf7495314c99095a2e4d66a") {
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088434cd2a371993ba41ea11448024fca32766b169183c9e691a7a433279da7e729") {
