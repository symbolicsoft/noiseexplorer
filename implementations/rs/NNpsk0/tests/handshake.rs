...
fn test() {
	...
	let initStaticA: NNpsk0::Keypair = NNpsk0::Keypair::new_k(NNpsk0::EMPTY_KEY);
	let initStaticB: NNpsk0::Keypair = NNpsk0::Keypair::new_k(NNpsk0::EMPTY_KEY);
	let respStatic: NNpsk0::Keypair = NNpsk0::Keypair::new_k(NNpsk0::EMPTY_KEY);
	let temp_psk1: [u8; 32] =
	...
	NNpsk0::NoiseSession::InitSession(true, &prologue, initStaticA, NNpsk0::EMPTY_KEY, temp_psk1);
	let mut responderSession: NNpsk0::NoiseSession =
	NNpsk0::NoiseSession::InitSession(false, &prologue, respStatic, NNpsk0::EMPTY_KEY, temp_psk2);
	initiatorSession.set_ephemeral_keypair(NNpsk0::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(NNpsk0::Keypair::new_k(decode_str_32(
