...
use noiseexplorer_nnpsk2::{noisesession::NoiseSession,
											...
											Keypair::from_private_key(responder_ephemeral_private,)
										{
											...
											if let Ok(mA,) = Message::from_str(
												...
												if let Ok(tA,) = Message::from_str(
													"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79447dabf550042b63cd69e1826848d383fce196ed4a9d55205c3e555ef49aaa3239",
												) {
													if let Ok(messageA,) =
															...
															.recv_message(messageA.clone(),)
														{
															if let Ok(mB,) = Message::from_str(
																...
																if let Ok(tB,) = Message::from_str(
																	"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088437ec230bbb3c3c83e65e2678f34d59bf01abb502670bb0e53b6bc8adb0646ea",
																) {
																	if let Ok(messageB,) =
																		responder_session
																			.send_message(mB,)
