...
fn test() {
	...
	let initStaticA: NX1::Keypair = NX1::Keypair::new_k(NX1::EMPTY_KEY);
	let initStaticB: NX1::Keypair = NX1::Keypair::new_k(NX1::EMPTY_KEY);
	let respStatic: NX1::Keypair = NX1::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let mut initiatorSession: NX1::NoiseSession =
	NX1::NoiseSession::InitSession(true, &prologue, initStaticA, NX1::EMPTY_KEY);
	let mut responderSession: NX1::NoiseSession =
	NX1::NoiseSession::InitSession(false, &prologue, respStatic, NX1::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(NX1::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(NX1::Keypair::new_k(decode_str_32(
		"bbdb4cdbd309f1a1f2e1456967fe288cadd6f712d65dc7b7793d5e63da6b375b"
	)));
	let payloadA = decode_str("4c756477696720766f6e204d69736573");
	let mut messageA: NX1::MessageBuffer = initiatorSession.SendMessage(&payloadA);
	...
	let mut messageB: NX1::MessageBuffer = responderSession.SendMessage(&payloadB);
	...
	let mut messageC: NX1::MessageBuffer = initiatorSession.SendMessage(&payloadC);
	...
	let mut messageD: NX1::MessageBuffer = responderSession.SendMessage(&payloadD);
	...
	let mut messageE: NX1::MessageBuffer = initiatorSession.SendMessage(&payloadE);
	...
	let mut messageF: NX1::MessageBuffer = responderSession.SendMessage(&payloadF);
