...
fn noiseexplorer_test_nxpsk2() {
                                        ...
                                        PrivateKey::from_str("4a6f686e2047616c74")
                                    {
                                            ...
                                            Keypair::from_private_key(responder_ephemeral_private)
                                        {
                                            ...
                                            if let Ok(mA) = Message::from_str(
                                                ...
                                                if let Ok(tA) = Message::from_str("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c794497bdcf5dc128b7bc5b8f2b6ac1a46dff9f9469337cfac0098f87b2a577cece84") {
	...
	if let Ok(tB) = Message::from_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f144808843c39479e89953f195c89ee9a53f2e291727e15ab09a61b1ca623ee98d3d2549bda7af1881b0ae7ba4bb6e8f71e119927c6c8510ae728cd8c258c6200b71c86e16f934ba80fe35e708f8a52a5e193346") {
