...
use noiseexplorer_npsk0::{noisesession::NoiseSession,
										...
										Keypair::from_private_key(initiator_ephemeral_private,)
									{
											...
											Message::from_str("4c756477696720766f6e204d69736573",)
										{
											if let Ok(tA,) = Message::from_str(
												"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c7944425cfde31517d0b610bab9bbd6e699b966415e2ce1454c0d5357dd445756df1f",
											) {
												if let Ok(messageA,) =
														...
														.recv_message(messageA.clone(),)
													{
														if let Ok(mB,) = Message::from_str(
															...
															if let Ok(tB,) = Message::from_str(
																"06aaf2d9845c8324f528f20bd1c8f8e11f88b55bc7681798e11d3f745c4264",
															) {
																if let Ok(messageB,) =
																	responder_session
																		.send_message(mB,)
																{
																	if let Ok(_x,) =
																		...
																		if let Ok(mC,) =
																			...
																			if let Ok(tC,) =
																				Message::from_str(
																					"a1ce8e06add10426bc54463a1e7dc3d9f9526f7b44225cfa8eda3a",
																				) {
