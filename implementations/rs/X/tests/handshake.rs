...
use noiseexplorer_x::{noisesession::NoiseSession,
									...
									Keypair::from_private_key(initiator_ephemeral_private,)
								{
										...
										Message::from_str("4c756477696720766f6e204d69736573",)
									{
										if let Ok(tA,) = Message::from_str(
											"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79448bc3b729d16d3944f1bfae9fa98e0d306234bfadc44880f99a69c6e55b6c1458e9c9dacab3f29aac44b435c57dc436d0830ae461a4479228789a38085be55b13e0128564987994de842e73dd0a5c328b",
										) {
											if let Ok(messageA,) =
													...
													.recv_message(messageA.clone(),)
												{
													if let Ok(mB,) = Message::from_str(
														...
														if let Ok(tB,) = Message::from_str(
															"aee89720731c98ccf15f4495ae3f6f2f7ed8e2164a1494c9e785b076e69cfc",
														) {
															if let Ok(messageB,) =
																responder_session.send_message(mB,)
															{
																	...
																	.recv_message(messageB.clone(),)
																{
																	if let Ok(mC,) =
																		...
																		if let Ok(tC,) =
																			Message::from_str(
																				"c88787701dc4365fe9dee7c0f23d91afdc214a459eadbc9f1d0220",
																			) {
																			if let Ok(messageC,) =
																				initiator_session
																					.send_message(
