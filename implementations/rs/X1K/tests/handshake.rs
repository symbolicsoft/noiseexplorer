...
fn test() {
	...
	let initStatic: X1K::Keypair = X1K::Keypair::new_k(X1K::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	X1K::NoiseSession::InitSession(true, &prologue, initStatic, respStatic.pk.0);
