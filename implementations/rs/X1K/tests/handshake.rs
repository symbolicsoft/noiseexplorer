...
use noiseexplorer_x1k::{noisesession::NoiseSession,
											...
											Keypair::from_private_key(responder_ephemeral_private,)
										{
											...
											if let Ok(mA,) = Message::from_str(
												...
												if let Ok(tA,) = Message::from_str(
													"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c7944a175ecb6df0c9d1986db9543b96d60c240c19f9a373a8aa5451ca32e4a5608f8",
												) {
													if let Ok(messageA,) =
															...
															.recv_message(messageA.clone(),)
														{
															if let Ok(mB,) = Message::from_str(
																...
																if let Ok(tB,) = Message::from_str(
																	"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f144808843c3e3deddc0219e7777000606fee22f8151e10720c99656f7e27c114704b278",
																) {
																	if let Ok(messageB,) =
																		responder_session
																			.send_message(mB,)
