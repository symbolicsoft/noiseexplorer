...
fn test() {
	...
	let initStaticA: X1N::Keypair = X1N::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: X1N::Keypair = X1N::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: X1N::Keypair = X1N::Keypair::new_k(X1N::EMPTY_KEY);
	let mut initiatorSession: X1N::NoiseSession =
	X1N::NoiseSession::InitSession(true, &prologue, initStaticA, X1N::EMPTY_KEY);
	let mut responderSession: X1N::NoiseSession =
	X1N::NoiseSession::InitSession(false, &prologue, respStatic, X1N::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(X1N::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(X1N::Keypair::new_k(decode_str_32(
		"bbdb4cdbd309f1a1f2e1456967fe288cadd6f712d65dc7b7793d5e63da6b375b"
	)));
	let payloadA = decode_str("4c756477696720766f6e204d69736573");
	let mut messageA: X1N::MessageBuffer = initiatorSession.SendMessage(&payloadA);
	...
	let mut messageB: X1N::MessageBuffer = responderSession.SendMessage(&payloadB);
	...
	let mut messageC: X1N::MessageBuffer = initiatorSession.SendMessage(&payloadC);
	...
	let mut messageD: X1N::MessageBuffer = responderSession.SendMessage(&payloadD);
	...
	let mut messageE: X1N::MessageBuffer = initiatorSession.SendMessage(&payloadE);
	...
	let mut messageF: X1N::MessageBuffer = responderSession.SendMessage(&payloadF);
