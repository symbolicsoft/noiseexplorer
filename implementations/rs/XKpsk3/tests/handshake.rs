...
fn test() {
	...
	let initStaticA: XKpsk3::Keypair = XKpsk3::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: XKpsk3::Keypair = XKpsk3::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: XKpsk3::Keypair = XKpsk3::Keypair::new_k(decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let temp_psk1: [u8; 32] =
	...
	XKpsk3::NoiseSession::InitSession(true, &prologue, initStaticA, respStatic.pk.0, temp_psk1);
	let mut responderSession: XKpsk3::NoiseSession =
	XKpsk3::NoiseSession::InitSession(false, &prologue, respStatic, XKpsk3::EMPTY_KEY, temp_psk2);
	initiatorSession.set_ephemeral_keypair(XKpsk3::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(XKpsk3::Keypair::new_k(decode_str_32(
