...
fn test() {
	...
	let initStaticA: XN::Keypair = XN::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let initStaticB: XN::Keypair = XN::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: XN::Keypair = XN::Keypair::new_k(XN::EMPTY_KEY);
	let mut initiatorSession: XN::NoiseSession =
	XN::NoiseSession::InitSession(true, &prologue, initStaticA, XN::EMPTY_KEY);
	let mut responderSession: XN::NoiseSession =
	XN::NoiseSession::InitSession(false, &prologue, respStatic, XN::EMPTY_KEY);
	initiatorSession.set_ephemeral_keypair(XN::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(XN::Keypair::new_k(decode_str_32(
