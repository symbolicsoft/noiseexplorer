...
use noiseexplorer_xnpsk3::{noisesession::NoiseSession,
											...
											Keypair::from_private_key(responder_ephemeral_private,)
										{
											...
											if let Ok(mA,) = Message::from_str(
												...
												if let Ok(tA,) = Message::from_str(
													"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c7944c5e7d2bbee60bd4d39b7f4cb74dce7fd3b39d29e5c927bd14b0aff695f892ba7",
												) {
													if let Ok(messageA,) =
															...
															.recv_message(messageA.clone(),)
														{
															if let Ok(mB,) = Message::from_str(
																...
																if let Ok(tB,) = Message::from_str(
																	"95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088430391ed5f1918d5d5b8725c3667ffb2e6d1bdd909f51cb00d3ac926093bf8bf",
																) {
																	if let Ok(messageB,) =
																		responder_session
																			.send_message(mB,)
