...
fn xnpsk3() {
	...
	let initStaticA: noiseexplorer_xnpsk3::Keypair = noiseexplorer_xnpsk3::Keypair::new_k(decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: noiseexplorer_xnpsk3::Keypair = noiseexplorer_xnpsk3::Keypair::new_k(noiseexplorer_xnpsk3::EMPTY_KEY);
	let temp_psk1: [u8; 32] =
	decode_str_32("54686973206973206d7920417573747269616e20706572737065637469766521");
	let temp_psk2: [u8; 32] =
	decode_str_32("54686973206973206d7920417573747269616e20706572737065637469766521");
	let mut initiatorSession: noiseexplorer_xnpsk3::NoiseSession =
	noiseexplorer_xnpsk3::NoiseSession::InitSession(true, &prologue, initStaticA, noiseexplorer_xnpsk3::EMPTY_KEY, temp_psk1);
	let mut responderSession: noiseexplorer_xnpsk3::NoiseSession =
	noiseexplorer_xnpsk3::NoiseSession::InitSession(false, &prologue, respStatic, noiseexplorer_xnpsk3::EMPTY_KEY, temp_psk2);
	initiatorSession.set_ephemeral_keypair(noiseexplorer_xnpsk3::Keypair::new_k(decode_str_32(
		"893e28b9dc6ca8d611ab664754b8ceb7bac5117349a4439a6b0569da977c464a"
	)));
	responderSession.set_ephemeral_keypair(noiseexplorer_xnpsk3::Keypair::new_k(decode_str_32(
		"bbdb4cdbd309f1a1f2e1456967fe288cadd6f712d65dc7b7793d5e63da6b375b"
	)));
	let payloadA = decode_str("4c756477696720766f6e204d69736573");
	let mut messageA: noiseexplorer_xnpsk3::MessageBuffer = initiatorSession.SendMessage(&payloadA);
	...
	let mut messageB: noiseexplorer_xnpsk3::MessageBuffer = responderSession.SendMessage(&payloadB);
	...
	let mut messageC: noiseexplorer_xnpsk3::MessageBuffer = initiatorSession.SendMessage(&payloadC);
	...
	let mut messageD: noiseexplorer_xnpsk3::MessageBuffer = responderSession.SendMessage(&payloadD);
	...
	let mut messageE: noiseexplorer_xnpsk3::MessageBuffer = initiatorSession.SendMessage(&payloadE);
	...
	let mut messageF: noiseexplorer_xnpsk3::MessageBuffer = responderSession.SendMessage(&payloadF);
