...
responder_session.set_ephemeral_keypair(responder_ephemeral_kp);
	...
	if let Ok(tB) = Message::from_bytes(&decode_str("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f1448088437c365eb362a1c991b0557fe8a7fb187d99346765d93ec63db6c1b01504ebeec55a2298d2dbff80eff034d20595153f63a196a6cead1e11b2bb13e336fa13616dd3e8b0a070c882ed3f1a78c7c06c93")[..]) {
	...
	if let Ok(tC) = Message::from_bytes(&decode_str("46c3307de83b014258717d97781c1f50936d8b7d50c0722a1739654d10392d415b670c114f79b9a4f80541570f77ce88802efa4220cff733e7b5668ba38059ec904b4b8eef9448085faf51")[..]) {
	...
	if let Ok(tD) = Message::from_bytes(&decode_str("d5e83adfaac5dc324a68f1862df54549e56d209fba707205f328b2")[..]) {
	...
	if let Ok(tE) = Message::from_bytes(&decode_str("d102c9029b1f55c788f561ba7737afbccef9c9f1bf2f238167fd40ba9c1c134867")[..]) {
	...
	if let Ok(tF) = Message::from_bytes(&decode_str("cb1ce80960382c6d5d5e740ffb724d1432f0310b200fb6f8424120f506092744baa415e155")[..]) {
