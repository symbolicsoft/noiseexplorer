...
fn test() {
	...
	let initStatic: XX1::Keypair = XX1::Keypair::new_k(XX1::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	XX1::NoiseSession::InitSession(true, &prologue, initStatic, XX1::EMPTY_KEY);
