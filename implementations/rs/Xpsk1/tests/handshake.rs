...
use noiseexplorer_xpsk1::{noisesession::NoiseSession,
										...
										Keypair::from_private_key(initiator_ephemeral_private,)
									{
											...
											Message::from_str("4c756477696720766f6e204d69736573",)
										{
											if let Ok(tA,) = Message::from_str(
												"ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c794479be957c06c64483c69607f17a61f440528418499b7f686adfb8091fb03643ac32b5823d51c15e00d9355d5623c817a552a0bb264052946463c288d45d9ede7c6ea227faafbb5f1dd11166d6ad3f7cc5",
											) {
												if let Ok(messageA,) =
														...
														.recv_message(messageA.clone(),)
													{
														if let Ok(mB,) = Message::from_str(
															...
															if let Ok(tB,) = Message::from_str(
																"cfbc17a5950121da51b421b0f95dbaa4745e70477be8da8871edd89049f998",
															) {
																if let Ok(messageB,) =
																	responder_session
																		.send_message(mB,)
																{
																	if let Ok(_x,) =
																		...
																		if let Ok(mC,) =
																			...
																			if let Ok(tC,) =
																				Message::from_str(
																					"a6a910d1067d991c63e8520bf327fa1f530a74fb47c58b8e3ff2a9",
																				) {
