...
fn test() {
	...
	let initStatic: I1X1::Keypair = I1X1::Keypair::new_k(I1X1::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	I1X1::NoiseSession::InitSession(true, &prologue, initStatic, I1X1::EMPTY_KEY);
