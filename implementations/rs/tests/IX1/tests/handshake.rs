...
fn test() {
	...
	let initStatic: IX1::Keypair = IX1::Keypair::new_k(IX1::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	IX1::NoiseSession::InitSession(true, &prologue, initStatic);
	let mut responderSession: IX1::NoiseSession =
	IX1::NoiseSession::InitSession(false, &prologue, respStatic);
