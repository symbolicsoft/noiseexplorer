...
fn test() {
	...
	let initStatic: K1K1::Keypair = K1K1::Keypair::new_k(K1K1::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	K1K1::NoiseSession::InitSession(true, &prologue, initStatic, respStatic.pk.0);
	let mut responderSession: K1K1::NoiseSession =
	K1K1::NoiseSession::InitSession(false, &prologue, respStatic, initStatic.pk.0);
