...
fn test() {
	...
	let initStatic: K1X::Keypair = K1X::Keypair::new_k(K1X::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	let respStatic: K1X::Keypair = K1X::Keypair::new_k(K1X::decode_str_32("4a3acbfdb163dec651dfa3194dece676d437029c62a408b4c5ea9114246e4893"));
	let mut initiatorSession: K1X::NoiseSession =
	K1X::NoiseSession::InitSession(true, &prologue, initStatic, K1X::EMPTY_KEY);
	let mut responderSession: K1X::NoiseSession =
	K1X::NoiseSession::InitSession(false, &prologue, respStatic, initStatic.pk.0);
