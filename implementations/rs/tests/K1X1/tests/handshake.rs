...
fn test() {
	...
	let initStatic: K1X1::Keypair = K1X1::Keypair::new_k(K1X1::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	K1X1::NoiseSession::InitSession(true, &prologue, initStatic, K1X1::EMPTY_KEY);
	let mut responderSession: K1X1::NoiseSession =
	K1X1::NoiseSession::InitSession(false, &prologue, respStatic, initStatic.pk.0);
