...
fn test() {
	...
	let initStatic: X1X::Keypair = X1X::Keypair::new_k(X1X::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	X1X::NoiseSession::InitSession(true, &prologue, initStatic);
	let mut responderSession: X1X::NoiseSession =
	X1X::NoiseSession::InitSession(false, &prologue, respStatic);
