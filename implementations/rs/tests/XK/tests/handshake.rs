...
fn test() {
	...
	let initStatic: XK::Keypair = XK::Keypair::new_k(XK::decode_str_32("e61ef9919cde45dd5f82166404bd08e38bceb5dfdfded0a34c8df7ed542214d1"));
	...
	XK::NoiseSession::InitSession(true, &prologue, initStatic, respStatic.pk.0);
