/* @ts-self-types="./noiseexplorer_xnpsk3_wasm.d.ts" */
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./noiseexplorer_xnpsk3_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('noiseexplorer_xnpsk3_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
